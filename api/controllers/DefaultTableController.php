...
class DefaultTableController {
    ...
    private function insertDataIntoTables(): void {
        DB::RawQueryExecute("
            ...
            insert into {$this->MOVIES} (id, name, duration, review, age_restriction, genre) values (3, 'Shadow', 2.1, 2.0, 21, 'Comedy|Crime|Mystery');
            ...
            insert into {$this->TICKETS} (id, movie_id,placeholder_id) values (1 , 4, 1);
            insert into {$this->TICKETS} (id, movie_id,placeholder_id) values (2 , 3, NULL);
            insert into {$this->TICKETS} (id, movie_id,placeholder_id) values (3 , 2, 2);
            insert into {$this->TICKETS} (id, movie_id,placeholder_id) values (4 , 1, NULL);
            insert into {$this->TICKETS} (id, movie_id,placeholder_id) values (5 , 5, 3);
